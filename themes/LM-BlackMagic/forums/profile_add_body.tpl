			...
			<div class="profile-edit-tab-pane tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0"><input class="form-control" type="text" name="username" id="username" value="{USERNAME}" autocomplete="username"></div>
					</div>

					<div class="form-group row mx-0">
						<label for="rname" class="col-12 col-lg-6 px-0">{L_NAME}</label>
						<div class="col-12 col-lg-6 px-0"><input class="form-control" type="text" name="rname" id="rname" value="{RNAME}"></div>
					</div>

					<div class="form-group row mx-0">
						<label for="email" class="col-12 col-lg-6 px-0">{L_EMAIL_ADDRESS}</label>
						<div class="col-12 col-lg-6 px-0"><input class="form-control" type="text" name="email" id="email" value="{EMAIL}"></div>
					</div>
				...
				<div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control" type="password" name="cur_password" id="cur_password" value="{CUR_PASSWORD}" autocomplete="current-password">
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control pass-autocomplete-off" type="password" name="new_password" id="new_password" value="{NEW_PASSWORD}" autocomplete="new-password">
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control pass-autocomplete-off" type="password" name="password_confirm" id="password_confirm" value="{PASSWORD_CONFIRM}" autocomplete="new-password">
				...
				<div class="tab-pane fade" id="public-info" role="tabpanel" aria-labelledby="public-info-tab">
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control" type="text" name="occupation" id="occupation" value="{OCCUPATION}">
						</div>
					</div>
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control" type="text" name="interests" id="interests" value="{INTERESTS}">
						</div>
					</div>
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control" type="text" name="{xdata.CODE_NAME}" id="{xdata.CODE_NAME}" maxlength="{xdata.MAX_LENGTH}" value="{xdata.VALUE}">
					...
					<div class="form-group row mx-0">
						<label for="{xdata.CODE_NAME}" class="col-12 col-lg-6 px-0">{xdata.NAME}</label>
						<div class="col-12 col-lg-6 px-0">
							<textarea name="{xdata.CODE_NAME}" id="{xdata.CODE_NAME}" class="form-control">{xdata.VALUE}</textarea>
							<small id="{xdata.CODE_NAME}HelpBlock" class="form-text text-muted">{xdata.DESCRIPTION}</small>
						</div>
					</div>
					...
					<div class="form-group row mx-0">
						<label for="{xdata.CODE_NAME}" class="col-12 col-lg-6 px-0">{xdata.NAME}</label>
						<div class="col-12 col-lg-6 px-0">
							<input class="form-check-input" type="checkbox" name="{xdata.CODE_NAME}" id="{xdata.CODE_NAME}" {xdata.switch_type_checkbox.CHECKED} />
							<small id="{xdata.CODE_NAME}HelpBlock" class="form-text text-muted">{xdata.DESCRIPTION}</small>
						</div>
					</div>
					...
					<div class="form-group row mx-0">
						<label for="{xdata.CODE_NAME}" class="col-12 col-lg-6 px-0">{xdata.NAME}</label>
						<div class="col-12 col-lg-6 px-0">
							<select class="form-control" name="{xdata.CODE_NAME}" id="{xdata.CODE_NAME}">
        						<!-- BEGIN options -->
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<!-- BEGIN options -->
							<input class="form-check-input" type="radio" name="{xdata.CODE_NAME}" id="{xdata.CODE_NAME}" value="{xdata.switch_type_radio.options.OPTION}" {xdata.switch_type_radio.options.CHECKED} />
				...
				<div class="tab-pane fade" id="preferences" role="tabpanel" aria-labelledby="preferences-tab">
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control" type="number" name="user_wordwrap" id="user_wordwrap" min="50" max="99" value="{WRAP_ROW}">
					...
					<div class="form-group row mx-0">
						<label for="language" class="col-12 col-lg-6 px-0">{L_BOARD_LANGUAGE}</label>
						<div class="col-12 col-lg-6 px-0">
							{LANGUAGE_SELECT}
						</div>
					</div>
					...
					<div class="form-group row mx-0">
						...
						<div class="col-12 col-lg-6 px-0">
							<input class="form-control col-10 col-lg-11" type="number" name="dst_time_lag" id="dst_time_lag" min="0" max="120" value="{DST_TIME_LAG}">&nbsp;{L_TIME_MODE_DST_MN}
						</div>
					</div>
				...
				<div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
					...
					<div class="form-group row mx-0">
						<label for="avatar-upload" class="col-12 col-lg-6 px-0">{L_UPLOAD_AVATAR_FILE}</label>
						<div class="col-12 col-lg-6 px-0">
