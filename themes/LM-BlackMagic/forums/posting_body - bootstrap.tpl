<section class="posting__body_wrapper">
	...
	<nav aria-label="breadcrumb" class="d-none d-xl-block px-0">
		<ol class="breadcrumb ">
			<li class="breadcrumb-item"><a href="{U_INDEX}">{L_INDEX}</a></li>
	...
	<div class="container-fluid">		
		...
		<div class="row justify-content-center mb-4 mt-4"><span class="messages__posting_title">{L_POST_A}</span></div>
		<form action="{S_POST_ACTION}" method="post" name="post" {S_FORM_ENCTYPE}>
			...
			<div class="row" style="line-height: 30px; padding: 4px;">
				...
				<div class="col-sm-12 col-lg-6 px-0">{L_OPTIONS}</div>
			...
			<div class="row mt-2 justify-content-center" style="line-height: 30px; padding: 4px;">
				<input class="btn btn-outline-primary mr-2 col-5 col-lg-2" type="submit" tabindex="5" name="preview" id="preview" value="{L_PREVIEW}" />
				<input class="btn btn-outline-success col-5 col-lg-2" type="submit" id="submit" accesskey="s" tabindex="6" name="post" value="{L_SUBMIT}" />
			</div>
