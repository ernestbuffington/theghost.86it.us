...
echo '<div class="fullscreen-bg">';
    echo '<video loop autoplay poster="themes/'.$theme_name.'/backgrounds/1920x1080dragonskull.png" class="fullscreen-bg__video">';
        //echo '<source src="themes/'.$theme_name.'/video/machine.webm" type="video/webm">';
        //echo '<source src="themes/'.$theme_name.'/video/2gb.mp4" type="video/mp4">';
        //echo '<source src="themes/'.$theme_name.'/video/machine.ogv" type="video/ogg">';
    echo '</video>';
echo '</div>';
...
$bullshit = $connected.', login to our facebook app and you will be able to us the like and comments sections of this web portal... Welcome back <strong><font color="yellow"><span class="blink-one">'.$username.'</span></font></strong>, It\'s quite awesome to see you my friend! We are so glad you could make it back over to visit... We know with your super tight busy schedule and all, it most certainly must have been quite a task! ::: '.$newmessages.' ::: Your current Monitor Resolution is <font color="#f48024">'.$screen_res.'</font> '.$moreuser_info.' ::: Your current browser version is <font color="#f48024">'.$titanium_browser->getVersion().'</font> ::: '.$scrollmsg.'</div>';
...
echo "\n\n<!-- START marquee -->\n\n";
echo '<div class="marquee_one"><font color="#ffc62a" size="2"><strong>'.$bullshit,'</strong></font></div>'."\n\n";
echo '<div class="marquee_two"><font color="#ffc62a" size="2"><strong>'.$bullshit2,'</strong></font></div>'."\n\n";
echo "<!-- END marquee -->\n\n";
